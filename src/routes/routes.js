...
export default [
    ...
    {path: "/klantenservice", name: "Klantenservice", Component: Customerservice},
    {path: "/over-ons", name: "Over ons", Component: AboutUs},
    {path: "/collectie", name: "Collectie", Component: CollectionPage},
    {path: "/collectie/heren", name: "Heren", Component: MensCollection},
    {path: "/collectie/dames", name: "Dames", Component: WomensCollection},
    {path: `/collectie/:productCategory/:productId`, name: "Huidig product", Component: ProductDetail},
    {path: "/login", name: "Login", Component: LoginPage},
    {path: "/aanmelden", name: "Aanmelden", Component: SignupPage},
    {path: "/email-register", name: "Registreren", Component: EmailSignUpPage},
    {path: "/wachtwoord-vergeten", name: "Wachtwoord vergeten", Component: ForgotPasswordPage},
    {path: "/algemene-voorwaarden", name: "Algemene Voorwaarden", Component: TermsAndConditions},
    {path: "/privacy", name: "Privacy", Component: PrivacyPage},
    {path: "/email-is-verzonden", name: "Email is verstuurd", Component: SendSuccessfullyPage},
