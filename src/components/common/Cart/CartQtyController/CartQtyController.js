...
const CartQtyController = ({increase, cartData, updateCart, specificProduct}) => {

    const cartIndex = cartData.map(function (e) {return e.title}).indexOf(specificProduct.title);
