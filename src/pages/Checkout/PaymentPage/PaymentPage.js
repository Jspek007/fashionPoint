...
const PaymentPage = () => {
    ...
    let cartData = JSON.parse(localStorage.getItem("checkoutData")) ? JSON.parse(localStorage.getItem("checkoutData"))
        : [];
    let shippingMethod = JSON.parse(localStorage.getItem("shippingMethod")) ? JSON.parse(localStorage.getItem("shippingMethod"))
        : [];
        ...
        <section className="checkout-container">
            ...
            <FormButtonContainer>
                <Link exact="true" to="/checkout/success">
                    <RedirectButton callToAction="Afrekenen" primary clickHandler={createOrder}/>
                </Link>
            </FormButtonContainer>
        </section>
    )
