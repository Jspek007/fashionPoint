    ...
    return (
        <>
            <section className="about-us-container">
                ...
                <SubTitle text="Wij nemen geen genoegen met minder. Onze filosofie is om altijd te verbeteren om het elke dag een beetje
            beter te doen, straight to the point. Maar hoe merk jij dit?"/>
            </section>
            <GridRowBanner imageSrc={FreeShipping} imgAlt="Free shipping!"
            ...
            <GridRowBanner imageSrc={ReturnService} imgAlt="Easy returns!"
                           ...
                           Nog een favoriet die toegevoegd kan worden aan de Points!" flipped/>
            <GridRowBanner imageSrc={CustomerService} imgAlt="Here for you!"
